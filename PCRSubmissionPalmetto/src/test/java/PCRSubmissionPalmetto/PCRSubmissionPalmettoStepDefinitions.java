...
public class PCRSubmissionPalmettoStepDefinitions {
	...
	private static final FunctionalBlockLogger logger = new FunctionalBlockLogger(PCRSubmissionPalmettoStepDefinitions.class);
	...
	@When("User Triggers the PCRSubmission Functionalblock with the given {string}")
	public void user_triggers_the_PCR_Submission_functionalblock_with_the_given(String testCaseInputs) throws Exception {
