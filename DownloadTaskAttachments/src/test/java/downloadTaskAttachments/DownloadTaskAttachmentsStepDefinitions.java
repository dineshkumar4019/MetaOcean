...
import downloadTaskAttachments.DownloadTaskAttachmentsStepDefinitions;

public class DownloadTaskAttachmentsStepDefinitions {
	...
	private static final FunctionalBlockLogger logger = new FunctionalBlockLogger(DownloadTaskAttachmentsStepDefinitions.class);
	...
	@When("User Triggers the DownloadtaskAttachments Functionalblock with the given {string}")
	public void user_triggers_the_DownloadtaskAttachments_functionalblock_with_the_given(String testCaseInput) throws Exception {
