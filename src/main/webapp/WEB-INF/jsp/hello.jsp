...
<head>
    <meta charset="utf-8">
    <meta name="google-signin-client_id" content="1061393341050-3964m5lf33fvn1vs3lm6vdnfud1reuue.apps.googleusercontent.com">
    ...
    <!-- Site Title  -->
    <title>Azure pro | ICO Crypto - ICO Landing Page &amp; Multi-Purpose Cryptocurrency HTML Template</title>
    <!-- Bundle and Base CSS -->
    <link rel="stylesheet" href="css/vendor.bundle.css?ver=200">
    <link rel="stylesheet" href="css/style-azure.css?ver=200">
    <!-- Extra CSS -->
    <link rel="stylesheet" href="css/theme.css?ver=200">
</head>
...
<body class="nk-body body-wider mode-onepage">
    <div class="nk-wrap">
                                ...
                                <div class="row align-items-center justify-content-center justify-content-lg-between">
                                            ...
                                            <div class="token-status token-status-s5 no-bd round animated" data-animate="fadeInUp" data-delay="1.35">
                                                ...
                                                <div class="progress-wrap progress-wrap-point progress-wrap-point-s1">
                                                    <div class="progress-bar progress-bar-sm progress-bar-s3 round-sm">
                                                        <div class="progress-percent progress-percent-s3 bg-accent" data-percent="75" style="width:75%;"></div>
                                                        <div class="progress-point progress-point-s1" data-point="20">Pre Sale </div>
                                                        <div class="progress-point progress-point-s1" data-point="45">Soft Cap </div>
                                                        <div class="progress-point progress-point-s1" data-point="75">Bonus </div>
                                                    </div>
                                                </div>
                                                <div class="token-action">
                                                    <a class="btn btn-secondary" href="#">REGISTER &amp; BUY TOKEN NOW</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
                                    <div class="col-lg-6 text-center text-lg-start">
                                        <div class="banner-caption cpn tc-light">
                                            <div class="cpn-head">
                                                <h1 class="title title-xl-2 title-lg title-semibold animated" data-animate="fadeInUp" data-delay="1.35">#1 Best Selling ICO Landing template for ICO Startup Agency</h1>
                                            </div>
                                            <div class="cpn-text">
                                                <p class="lead-s2 animated" data-animate="fadeInUp" data-delay="1.45">Most Trending, Clean and Elegant Design based on deeply research</p>
                                            </div>
                                            <div class="cpn-action">
                                                <ul class="cpn-links animated" data-animate="fadeInUp" data-delay="1.55">
                                                    <li><a href="#" class="btn btn-md btn-grad">Sign up to join</a></li>
                                                    <li><a href="#" class="btn btn-md btn-grad">Token Distribution</a></li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div><!-- .col -->
        ...
        <main class="nk-pages bg-transparent">
                        ...
                        <div class="row align-items-center justify-content-center justify-content-lg-between gutter-vr-30px">
                            <div class="col-lg-6 col-sm-9 pdb-m">
                                <div class="nk-block-text text-center text-lg-start">
                                    <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">What is ICo Crypto</h6>
                                    <h2 class="title title-semibold animated" data-animate="fadeInUp" data-delay=".2">We’ve built a platform <br>to buy and sell shares.</h2>
                                    <p class="lead-s2 animated" data-animate="fadeInUp" data-delay=".3">ICO Crypto is a platform for the future of funding that powering dat for the new equity blockchain.</p>
                            ...
                            <div class="col-lg-5 col-sm-9">
                                <div class="nk-block-video animated" data-animate="fadeInUp" data-delay=".6">
                                    <img src="images/azure/gfx-y-light.png" alt="image">
                                    <a href="https://www.youtube.com/watch?v=SSo_EIwHSd4" class="nk-block-video-play video-popup btn-play-wrap btn-play-wrap-s2">
            ...
            <section class="section bg-white ov-h">
                <div class="container">
                    <div class="section-head section-head-s3 wide-auto-sm text-center">
                        <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">Why ICO Crypto</h6>
                        <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">Competitive Advantage</h2>
                        <p class="animated" data-animate="fadeInUp" data-delay=".3">With help from our teams, contributors and investors these are the milestones we are looking forward to achieve.</p>
                    </div>
                    <div class="nk-block">
                        <div class="row justify-content-center gutter-vr-30px">
                            <div class="col-lg-4 col-sm-8">
                                <div class="feature text-center animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="feature-icon feature-icon-s8">
                                        <img src="images/gfx/gfx-sm-e-light.png" alt="feature">
                                    </div>
                            ...
                            <div class="col-lg-4 col-sm-8">
                                <div class="feature text-center animated" data-animate="fadeInUp" data-delay=".5">
                                    <div class="feature-icon feature-icon-s8">
                                        <img src="images/gfx/gfx-sm-f-light.png" alt="feature">
                                    </div>
                                    <div class="feature-text">
                            ...
                            <div class="col-lg-4 col-sm-8">
                                <div class="feature text-center animated" data-animate="fadeInUp" data-delay=".6">
                                    <div class="feature-icon feature-icon-s8">
                                        <img src="images/gfx/gfx-sm-g-light.png" alt="feature">
                                    </div>
                                    <div class="feature-text">
                        ...
                        <div class="text-center pdt-r">
                            <ul class="btn-grp animated" data-animate="fadeInUp" data-delay=".7">
                                <li><a href="#" class="btn btn-grad btn-md">Download Whitepaper</a></li>
                                <li><a href="#" class="btn btn-grad btn-md">Apply To Get Whitelisted</a></li>
                            </ul>
                            <div class="pdt-r animated" data-animate="fadeInUp" data-delay=".8">
                                <a href="#" class="link link-light link-xs">
                                    <em class="link-icon fa fa-paper-plane"></em><span>Join us on Telegram</span>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <section class="section section-tokensale bg-theme-grad-s2 tc-light ov-h" id="tokens">
                <div class="container">
                    <!-- Block @s -->
                    <div class="nk-block nk-block-token">
                        <div class="section-head section-head-s3 wide-auto-sm text-center">
                            <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">Token</h6>
                            <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">Pre-Sale &amp; Values</h2>
                            <p class="animated" data-animate="fadeInUp" data-delay=".3">ICO Crypto token will be released on the basis of Ethereum and Bitocin platform. It’s compatibility of the token with third-party services wallets, exchanges etc, and provides easy-to-use integration.</p>
                        </div>
                        <div class="row align-items-center justify-content-between gutter-vr-30px">
                            ...
                            <div class="col-lg-5">
                                <div class="token-status token-status-s5 bg-grad no-bd round tc-light animated" data-animate="fadeInUp" data-delay="1">
                                    <div class="token-box token-box-s3">
                                        <h4 class="title title-sm">PRE SALE STARTING IN</h4>
                                        <div class="countdown-s3 countdown-s4 countdown" data-date="2022/06/11"></div>
                                    </div>
                                    <div class="token-action">
                                        <a class="btn btn-md btn-grad btn-grad-alternet btn-round" href="#">Join &amp; BUY TOKEN NOW</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row gutter-vr-40px justify-content-center">
                            <div class="col-lg-6 col-mb-10">
                                <div class="single-chart text-center">
                                    <h3 class="title title-lg pdb-l animated" data-animate="fadeInUp" data-delay=".1">Initial Token Distribution</h3>
                            ...
                            <div class="col-lg-6 col-mb-10">
                                <div class="single-chart text-center">
                                    <h3 class="title title-lg pdb-l animated" data-animate="fadeInUp" data-delay=".3">Sale Proceed Allocation</h3>
            ...
            <section class="section bg-light ov-h" id="roadmap">
                <div class="container">
                    <div class="section-head section-head-s3 wide-auto-sm text-center">
                        <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">Roadmap</h6>
                        <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">The Timeline</h2>
                        <p class="animated" data-animate="fadeInUp" data-delay=".3">With help from our teams, contributors and investors these are the milestones we are looking forward to achieve.</p>
                    </div>
                    <!-- Block @s -->
                    <div class="nk-block">
            ...
            <section class="section bg-white pb-0 ov-h" id="tokens">
                <div class="container">
                    <div class="section-head section-head-s3 wide-auto-sm text-center">
                        <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">Token</h6>
                        <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">ICO Apps</h2>
                        <p class="animated" data-animate="fadeInUp" data-delay=".3">Once you’ve entered into our ecosystem, you can mange every thing. Anyone with a smartphone and an internet connection can participate in global marketplace.</p>
                    </div>
                    <!-- Block @s -->
                        ...
                        <div class="row align-items-center justify-content-center gutter-vr-40px">
                            <div class="col-md-6 col-sm-9">
                                <div class="nk-block-text pdb-l">
                                    ...
                                    <ul class="list list-dot pdb-r">
                                        <li class="animated" data-animate="fadeInUp" data-delay=".45">Crypto-news curation</li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".5">Natural Language Understanding</li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".55">Wallet aggregation</li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".6">Professional Network</li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".65">No more expensive fees</li>
                                    </ul>
                                    <ul class="btn-grp justify-content-center justify-content-md-start">
                                        <li class="animated" data-animate="fadeInUp" data-delay=".75"><a href="#" class="btn btn-grad btn-md">Get the app now</a></li>
                            ...
                            <div class="col-md-6 col-sm-9 align-self-end">
                                <div class="nk-block-img me-md-n5 me-lg-0 animated" data-animate="fadeInUp" data-delay=".6">
                                    <img src="images/app-screens/sc-large-o-dark.png" alt="app">
                                </div>
                            </div>
                        </div><!-- .row -->
                    </div><!-- .block @e -->
            ...
            <section class="section bg-theme-alt tc-light ov-h" id="team">
                <div class="container">
                    <div class="section-head section-head-s3 wide-auto-sm text-center">
                        <h6 class="title title-xs title-xs-s3 tc-primary animated" data-animate="fadeInUp" data-delay=".1">Our Team</h6>
                        <h2 class="title animated" data-animate="fadeInUp" data-delay=".2">The Leadership Team</h2>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay=".4">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-a.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-1" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Waylon <br>Dalton</h5>
                            ...
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay=".5">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-b.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-2" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Jonathan <br>Rios</h5>
                            ...
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay=".6">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-c.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-3" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Jason <br>Morales</h5>
                            ...
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay=".7">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-d.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-4" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Joseph <br>Jordan</h5>
                    ...
                    <div class="nk-block nk-block-team-list">
                        <div class="section-head section-head-sm text-center">
                            <h2 class="title-lg-2 title-semibold animated" data-animate="fadeInUp" data-delay=".8">The Advisory board</h2>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay=".9">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-a.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-5" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Louis <br>Baker</h5>
                                    <span class="team-position">CEO &amp; Lead Blockchain</span>
                                    <ul class="team-social team-social-vr team-social-s2">
                                        <li><a href="#"><em class="fab fa-facebook-f"></em></a></li>
                                        <li><a href="#"><em class="fab fa-twitter"></em></a></li>
                            ...
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay="1">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-b.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-6" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Jonathan <br>Rios</h5>
                                    <span class="team-position">CTO &amp; Software Engineer</span>
                                    <ul class="team-social team-social-vr team-social-s2">
                            ...
                            <div class="col-lg-3 col-mb-6">
                                <div class="team team-s5 animated" data-animate="fadeInUp" data-delay="1.1">
                                    <div class="team-photo team-photo-s1">
                                        <img src="images/team/sq-c.jpg" alt="team" class="no-bdrs">
                                        <a href="#team-popup-7" class="team-show content-popup" data-overlay="bg-grad-alt"></a>
                                    </div>
                                    <h5 class="team-name title title-md">Jason <br>Morales</h5>
                                    <span class="team-position">Sr.Backend developer</span>
                                    <ul class="team-social team-social-vr team-social-s2">
                                        ...
                                        <div class="row gutter-vr-50px">
                                            <div class="col-md-6">
                                                <div class="nk-block-text">
                                                    <h5 class="title title-sm">What is ICO Crypto? </h5>
                                            ...
                                            <div class="col-md-6">
                                                <div class="nk-block-text">
                                                    <h5 class="title title-sm">What cryptocurrencies can I use to purchase? </h5>
                                                    <p>Once ICO period is launched, You can purchased Token with Etherum, Bitcoin or Litecoin. You can also tempor incididunt ut labore et dolore magna aliqua sed do eiusmod eaque ipsa.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="nk-block-text">
                                                    <h5 class="title title-sm">How can I participate in the ICO Token sale? </h5>
                                                    <p>Once ICO period is launched, You can purchased Token with Etherum, Bitcoin or Litecoin. You can also tempor incididunt ut labore et dolore magna aliqua sed do eiusmod eaque ipsa.</p>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="nk-block-text">
                                                    <h5 class="title title-sm">How do I benefit from the ICO Token? </h5>
                                                    <p>Once ICO period is launched, You can purchased Token with Etherum, Bitcoin or Litecoin. You can also tempor incididunt ut labore et dolore magna aliqua sed do eiusmod eaque ipsa.</p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <section class="section section-contact bg-theme-dark tc-light">
                <div class="container">
                    ...
                    <div class="section-head text-center wide-auto-sm">
                        <h4 class="title-xs title-semibold animated" data-animate="fadeInUp" data-delay=".1">As Seen In</h4>
                    </div><!-- .section-head @e -->
                    <!-- Block @s -->
                    <div class="nk-block block-partners">
                        <ul class="partner-list partner-list-s2 flex-wrap mgb-m30">
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".2"><img src="images/partners/a-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".25"><img src="images/partners/b-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".3"><img src="images/partners/c-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".35"><img src="images/partners/d-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".4"><img src="images/partners/e-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".45"><img src="images/partners/f-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".5"><img src="images/partners/a-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".55"><img src="images/partners/b-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".6"><img src="images/partners/c-xs-light.png" alt="partner"></li>
                            <li class="partner-logo-s3 animated" data-animate="fadeInUp" data-delay=".66"><img src="images/partners/d-xs-light.png" alt="partner"></li>
                        </ul>
                    </div>
                </div>
            </section>
                        ...
                        <div class="row justify-content-between gutter-vr-30px">
                            <div class="col-lg-4 col-sm-6">
                                <div class="wgs wgs-menu">
                                    <a href="#" class="wgs-logo animated" data-animate="fadeInUp" data-delay=".1">
                                        <img src="images/logo-full-white.png" alt="logo">
                                    </a>
                                    <ul class="social">
                                        <li class="animated" data-animate="fadeInUp" data-delay=".45"><a href="#"><em class="social-icon fab fa-bitcoin"></em></a></li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".25"><a href="#"><em class="social-icon fab fa-facebook-f"></em></a></li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".3"><a href="#"><em class="social-icon fab fa-twitter"></em></a></li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".35"><a href="#"><em class="social-icon fab fa-medium-m"></em></a></li>
                                        <li class="animated" data-animate="fadeInUp" data-delay=".4"><a href="#"><em class="social-icon fab fa-github"></em></a></li>
                                    </ul>
                                </div>
                            </div><!-- .col -->
                            <div class="col-lg-4 col-sm-6">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7">
                                    <div class="copyright-text copyright-text-s3">
                                        <p><span class="d-block">Copyright &copy; 2022, ICO Crypto. Template Made By <a href="#">Softnio</a> &amp; Handcrafted by iO.</span> All trademarks and copyrights belong to their respective owners.</p>
                                    </div>
                                </div>
                    ...
                    <div class="ath-body">
                        ...
                        <form id="myForm">
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" class="input-bordered" id="username" name="username" placeholder="Your Email"/>
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                            ...
                            <a id="login-submit" type="submit" value="Submit!" class="btn btn-primary btn-block btn-md">Sign In</a>
                        </form>
                ...
                <div class="ath-container m-0">
                    <div class="ath-body">
                        ...
                        <form>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" path="name" class="input-bordered" placeholder="Your Name"/>
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="text" path="email" class="input-bordered" placeholder="Your Email"/>
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <input type="password" path="password" class="input-bordered" placeholder="Password"/>
                                </div>
                            </div>
                            <div class="field-item">
                                <div class="field-wrap">
                                    <type="password" path="repeatPassword" class="input-bordered" placeholder="Repeat Password"/>
                                </div>
                            </div>
                            <div class="field-item">
                            ...
                            <button class="btn btn-primary btn-block btn-md" type = "submit" id="submit-id">Sign Up</button>
                        </form>
                        <div class="sap-text"><span>Or Sign Up With</span></div>
                        <ul class="btn-grp gutter-20px gutter-vr-20px">
                            <li class="col"><a href="#" class="btn btn-md btn-facebook btn-block"><em class="icon fab fa-facebook-f"></em><span>Facebook</span></a></li>
                            <li class="col"><span id="googleSingIn" class="btn btn-md btn-google btn-block"><em class="icon fab fa-google"></em><span>Google</span></a></li>
                        </ul>
                ...
                <div class="ath-container m-0">
                    <div class="ath-body">
                        ...
                        <form action="#">
                            ...
                            <a class="btn btn-primary btn-block btn-md">Reset Password</a>
    ...
    <!-- JavaScript -->
    <script src="/js/jquery.bundle.js?ver=200"></script>
    <script src="/js/scripts.js?ver=200"></script>
    <script src="/js/metaScripts.js?ver=200"></script>
    <script src="js/charts.js?ver=200"></script>
    <script src="js/charts.js?ver=200"></script
